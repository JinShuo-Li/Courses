...
先介绍一下描述电场的两种方法: 电场线和电通量.

- 电场线: 曲线上任何一点的切线方向都与该点处的场强方向一致.

补充约定: $E = \frac{dN}{dS}$

当然, 静电场中, 电场线是从正电荷出发, 指向负电荷的. 电场线的疏密程度表示该处的场强大小, 电场线越密集, 场强越大. 电场线不能相交, 也不能闭合.

- 电通量: 通过电场任意给定面的电场线总根数, 即为通过该面的电通量

$$ d \Phi = E \cdot dS = E_n dS $$

**高斯定理**: 通过任意闭合曲面的电通量等于该曲面内所包围的电荷的代数和除以真空介电常数.
